...
namespace LibrarySystem.Api.Migrations
{
    ...
    [Migration("20260520153322_AddBookPublisherAndPageCount")]
    partial class AddBookPublisherAndPageCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibrarySystem.Api.Entities.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibrarySystem.Api.Entities.UserNotification", b =>
                {
                    b.HasOne("LibrarySystem.Api.Entities.BorrowRecord", "BorrowRecord")
                        .WithMany()
